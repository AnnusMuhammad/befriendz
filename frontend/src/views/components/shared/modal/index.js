      ...
      >
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex  items-end justify-center p-4 text-center sm:items-center sm:p-0 m-4">
            ...
            >
              <Dialog.Panel
                className={`relative transform overflow-hidden max-h-[90vh] rounded-3xl bg-white px-4 pb-4 pt-5 text-left transition-all sm:my-8 sm:w-full sm:p-6  
                ${size === "xs" && "sm:max-w-md"}
                ${size === "sm" && "sm:max-w-lg"}
                    ...
                    <Dialog.Title className="leading-6">
                      <>
                        ...
                        >
                          ...
                          <div className="absolute right-0 sm:top-0 -top-8">
                            <button
                              type="button"
