...
export const createError = (res, e, next) => {
  ...
  if (
    !e.message ||
    (e.statusCode == 500 && process.env.APP_ENV === "production")
  ) {
...
export const convertDateTimeToUnix = (date) =>
  moment(date, "YYYY-MM-DD").utcOffset(APP_CONSTANT.DEFAULT_TIME_ZONE).unix();
...
export const getCurrentDateTime = () =>
  moment().utcOffset(APP_CONSTANT.DEFAULT_TIME_ZONE);
